...
export default function ChatConversationScreen() {
  ...
  const { data: messages = [], isLoading } = useMessages(currentUserId, effectiveFriendId, conversationId);
  const sendMessage = useSendMessage(currentUserId, effectiveFriendId, conversationId);
  const markRead = useMarkMessagesRead(currentUserId, effectiveFriendId, conversationId);
  ...
  useEffect(() => {
    ...
    const queryKey = ['messages', conversationId ?? effectiveFriendId, currentUserId, effectiveFriendId];
